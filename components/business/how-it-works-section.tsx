...
const steps = [
  {
    ...
    description:
      "Upload research reports, filings, or internal documents. Handle both scanned and digital PDFs with built-in OCR.",
...
file: report.pdf`,
  },
  {
    ...
    description:
      "Automatically identify companies, sectors, metrics, and key insights. Convert raw documents into structured data.",
    code: `{
  ...
  {
    number: "III",
    title: "Search and query insights",
    description:
      "Ask questions across all documents and get precise, source-linked answers with full context.",
    code: `Query: "What are risks to IT sector?"

→ Answer with citations from reports`,
  },
  {
    number: "IV",
    title: "Analyze and visualize",
    description:
      "Explore relationships between companies, sectors, and themes through graphs and interactive insights.",
    code: `Graph:
TCS → IT Sector → Export Demand → USD Trends`,
  },
];
