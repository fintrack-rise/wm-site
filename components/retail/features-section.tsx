...
const features = [
  {
    number: "01",
    title: "Follow experts, not platforms",
    description: "Track insights from multiple experts in one place—across reports, videos, and posts.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Turn long content into quick signals",
    description: "Get concise summaries from research reports and videos with clear takeaways.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Ask questions, get source-backed answers",
    description: "Query across reports and videos. Every answer is linked to original context.",
    visual: "collab",
  },
  {
    number: "04",
    title: "See the bigger picture",
    description: "Understand how experts, sectors, and companies connect over time.",
    visual: "security",
  },
];
