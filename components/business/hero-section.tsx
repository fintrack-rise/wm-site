      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground">
            ...
            The platform for modern financial teams
          </span>
        </div>
        ...
        <div className="mb-12">
          <h1
            className="font-display text-[clamp(3rem,12vw,10rem)] leading-[0.9] tracking-tight"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Your system for turning documents into intelligence.
            Extract, structure, and query financial data—at scale.
          </p>
          ...
          >
            <Button
              ...
              onClick={openAppFromBusinessHero}
            >
              Experience insights app
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "Any PDF", label: "Scanned or digital document ingestion" },
                { value: "Structured data", label: "From unstructured financial content" },
                { value: "Source-backed", label: "Every answer with traceable context" },
                { value: "Unified search", label: "Query across all documents" },
                { value: "Entity-level", label: "Companies, sectors, relationships mapped" },
                { value: "Scalable", label: "Built for teams and large document sets" },
              ].map((stat) => (
