...
const features = [
  {
    number: "01",
    title: "Ingest any financial document",
    description:
      "Upload scanned or text PDFs and extract clean, structured data instantly. Built-in OCR and parsing handle complex financial documents without manual effort.",
    visual: "ingest",
  },
  {
    number: "02",
    ...
    description:
      "Automatically identify companies, sectors, metrics, and key insights. Turn raw documents into a structured, queryable intelligence layer.",
    visual: "collab",
  },
  {
    number: "03",
    title: "Search and query everything",
    description:
      "Ask questions across all documents and get precise, source-backed answers. No more digging through reports or scattered files.",
    visual: "ai",
  },
  {
    number: "04",
    title: "Visualize relationships and insights",
    description:
      "Explore connections between entities, trends, and themes through graphs and interactive views. Understand the bigger picture faster.",
    visual: "security",
  },
];
